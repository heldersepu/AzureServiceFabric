...
namespace RestockRequestManager.Service
{
    ...
    internal class RestockRequestManagerService : StatefulService, IRestockRequestManager, IRestockRequestEvents
    {
        ...
        private const string ItemIdToActorIdMapName = ""; //Name of ItemId-ActorId IReliableDictionary
        private const string CompletedRequestsQueueName = ""; //Name of CompletedRequests IReliableQueue
        private const string InventoryServiceName = "";
