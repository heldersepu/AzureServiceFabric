...
namespace Inventory.Service
{
    ...
    {
        internal const string InventoryServiceType = "[Update-this-service-type]";
        private const string InventoryItemDictionaryName = "[Update-this-dictionary-name]";
        private const string ActorMessageDictionaryName = "[Update-this-dictionary-name]";
        private const string RestockRequestManagerServiceName = "[Update-this-service-name]";
        private const string RequestHistoryDictionaryName = "[Update-this-dictionary-name]";
        private const string BackupCountDictionaryName = "[Update-this-dictionary-name]";
